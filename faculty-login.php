...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT faculty_ID FROM faculty WHERE faculty_name = '$myusername' and password = '$mypassword'";
        ...
        <div class='login-form'>
            ...
            <form action='' method='POST'>
                ...
                <p class='align-center'>
                    ...
                    <button type='button' class='signup-button' onclick="window.location.href='faculty-signup.php'">Signup</button>
                </p>
            </form>
